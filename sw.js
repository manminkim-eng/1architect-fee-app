/* ═══════════════════════════════════════════════════════════════
   공공기관 건축사 업무대가 산출기 — Service Worker
   ARCHITECT KIM MANMIN · Ver-3.0
   전략: Cache-First (로컬 자산) + Network-First (외부 CDN)
   ═══════════════════════════════════════════════════════════════ */

const CACHE_NAME   = 'arch-fee-calc-v3.0';
const CDN_CACHE    = 'arch-fee-calc-cdn-v3.0';
...
self.addEventListener('push',(event)=>{
  const data=event.data?.json()??{title:'건축사 업무대가 산출기',body:'업데이트가 있습니다.'};
